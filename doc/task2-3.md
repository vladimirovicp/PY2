...
__contains__: для проверки наличия элемента в коллекции. Данный метод необходим, если хотите, чтобы ваш экземпляр мог взаимодействовать с конструкцией in в Python
...
"""Теоретическая задача. Для ознакомления"""
